...
AS $$
    BEGIN
        ...
        -- Unravel the unique documents
        RAISE NOTICE 'POPULATING document...';
        INSERT INTO "public"."document"
        (doc_id, action_date)

        -- TODO Make this into a function
        -- Get the minimum start date "action date" of a document
        ...
        (
            ...
            (
                ...
                FROM
                (
                    -- sanitize/standardize non standard fields from ingested documents
                    SELECT raw_id,
        ...
        -- Clean up nonstandard fields in the data
        ...
        -- Populate senate sponsors based on senate_id
        ...
        -- Populate sponsors based on bio_id
        ...
        -- Populate cosponsors based on senate_id
        ...
        -- Populate cosponsors based on bio_id
        ...
        -- Populate committees based on the data tied to the committe table
        ...
        -- Create a standardized committe name from info we are given
        ...
        -- Try real hard to pick the correct committe name
